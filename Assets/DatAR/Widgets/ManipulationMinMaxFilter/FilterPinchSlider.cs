...
//
// Modified by the DatAR Research Group
...
namespace DatAR.Widgets.ManipulationMinMaxFilter {
    ...
    [AddComponentMenu("Scripts/MRTK/SDK/FilterPinchSlider")]
    public class FilterPinchSlider : MonoBehaviour, IMixedRealityPointerHandler
    {
        ...
        public Vector3 SliderEndPosition
        {
            ...
            get { return EndPosition.position; }
        }
