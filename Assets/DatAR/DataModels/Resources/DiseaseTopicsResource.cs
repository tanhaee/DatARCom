...
{
    public sealed class DiseaseTopicsResource : DynamicResource
    {
        public DiseaseTopicsResource(List<string> types, int appearTimes, DynamicResource concept, DynamicResource disease)
        {
            Types = types;
